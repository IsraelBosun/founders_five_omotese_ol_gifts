  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-14 lg:py-20">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
          {products.map((product, i) => (
            <ScrollReveal key={product.id} delay={i * 90} variant="scale">
              <Link href={`/shop/${product.slug}`} className="group block active:scale-[0.98] transition-transform duration-100">
      ...
      <ScrollReveal className="mx-6 lg:mx-12 mb-16">
        <div className="bg-purple-deep rounded-3xl py-14 px-8 lg:px-14 flex flex-col lg:flex-row items-center justify-between gap-8">
          <div>
